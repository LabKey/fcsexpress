...
{
    public FCSExpressProtocolSchema(User user, Container container, @NotNull FCSExpressAssayProvider provider, @NotNull ExpProtocol protocol, @Nullable Container targetStudy)
    {
